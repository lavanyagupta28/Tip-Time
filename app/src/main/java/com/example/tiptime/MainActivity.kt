...
fun EditNumberField(
    ...
    TextField(
        ...
        singleLine = true, // allows to enter input in one single line instead of multiple lines
        value = value,

        onValueChange = onValueChange,
        modifier = modifier,
        keyboardOptions = keyboardOptions
        )   // allows us to get app specific required keyboard
}
@Composable
...
fun TipTimeLayout(){
    ...
    Column(modifier = Modifier.statusBarsPadding().padding(horizontal = 40.dp)
